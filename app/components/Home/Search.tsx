...
const Search = ({ searchInput, inputHandler }: Props) => {
  ...
  return (
    <div className="mb-10 pt-8 flex justify-center">
      <div className="mx-6 px-10 py-4 flex gap-8 place-items-center bg-white shadow-md rounded-md w-screen md:w-auto md:mx-0 lg:w-auto lg:mx-0 2xl:w-auto 2xl:mx-0 dark:bg-[hsl(209,23%,22%)]">
        <FontAwesomeIcon
